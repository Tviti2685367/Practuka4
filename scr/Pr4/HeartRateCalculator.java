// Класс для розрахунку частоти серцевих скорочень
public class HeartRateCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Частота серцевих скорочень при температурі " + bodyTemperature + " градусів Цельсія: " + heartRate + " ударів в хвилину");
    }
}
